...
def filter_analysis_population(
    df: pd.DataFrame, population_flag: str = "saffl", analysis_flag: str = "anl01fl"
) -> pd.DataFrame:
    """
...
def transpose_dataset(
    ...
    transposed = df.melt(id_vars=id_vars, value_vars=value_vars, var_name=var_name, value_name=value_name)
