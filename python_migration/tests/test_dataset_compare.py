...
from sas_clinical.comparison.dataset_compare import DatasetComparison, compare_vars, compare_datasets
...
class TestDatasetComparison:
    ...
    def test_compare_datasets_numeric_tolerance(self):
        ...
        df1 = pd.DataFrame({"id": [1, 2, 3], "value": [1.0000001, 2.0000001, 3.0000001]})
        df2 = pd.DataFrame({"id": [1, 2, 3], "value": [1.0, 2.0, 3.0]})
